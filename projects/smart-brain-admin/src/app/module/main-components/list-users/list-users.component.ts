...
export class ListUsersComponent implements AfterViewInit {
  ...
  searchByOrg() {
    const searchFunction = this.selectedOrganizationId ? this.userService.findAllByOrganization : this.userService.findAll;
    searchFunction.call(this.userService, this.selectedOrganizationId).subscribe((users) => {
