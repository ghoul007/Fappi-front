...
declare module fhir.r4 {
   ...
   * Messages supported by this system
   */
  interface CapabilityStatementMessagingSupportedMessage
   ...
   * Benefit Summary
   */
  interface CoverageEligibilityResponseInsuranceItemBenefit
    extends BackboneElement {
    /**
     * Benefit classification
     */
   ...
   * Dates governing proposed immunization
   */
  interface ImmunizationRecommendationRecommendationDateCriterion
    extends BackboneElement {
    /**
     * Type of date
     */
   ...
   * Stratifier component values
   */
  interface MeasureReportGroupStratifierStratumComponent
    extends BackboneElement {
    /**
   ...
   */
  interface MedicationKnowledgeRelatedMedicationKnowledge
    extends BackboneElement {
    /**
   ...
   */
  interface MedicationKnowledgeAdministrationGuidelines
    extends BackboneElement {
    /**
   ...
   * Dosage for the medication for the specific guidelines
   */
  interface MedicationKnowledgeAdministrationGuidelinesDosage
    extends BackboneElement {
    /**
     * Type of dosage
     */
   ...
   * Characteristics of the patient that are relevant to the administration guidelines
   */
  interface MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics
    extends BackboneElement {
    /**
   ...
   * First fill details
   */
  interface MedicationRequestDispenseRequestInitialFill
    extends BackboneElement {
    /**
     * First fill quantity
     */
   ...
   */
  interface MedicinalProductManufacturingBusinessOperation
    extends BackboneElement {
    /**
   ...
   */
  interface MedicinalProductPharmaceuticalCharacteristics
    extends BackboneElement {
    /**
   ...
   * A species for which this route applies
   */
  interface MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpecies
    extends BackboneElement {
    /**
   ...
   * A species specific time during which consumption of animal product is not appropriate
   */
  interface MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriod
    extends BackboneElement {
    /**
   ...
   * Additive associated with container
   */
  interface SpecimenDefinitionTypeTestedContainerAdditive
    extends BackboneElement {
    /**
     * Additive associated with container
     */
   ...
   * Todo
   */
  interface SubstanceReferenceInformationClassification
    extends BackboneElement {
    /**
     * Todo
     */
   ...
   * Each operation can have one or more header elements
   */
  interface TestScriptSetupActionOperationRequestHeader
    extends BackboneElement {
    /**
